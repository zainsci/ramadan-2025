...
const Layout: React.FC<LayoutProps> = ({ children }) => {
	...
	return (
		<div className="min-h-screen bg-white flex flex-col">
			...
			{/* Main Content */}
			<main className="flex-grow p-4 font-mono flex justify-center">
				<div className="w-full max-w-4xl">{children}</div>
			</main>

			{/* Brutalist Footer - will be hidden during print */}
			<footer className="bg-black text-white p-4 text-center border-t-8 border-blue-400 font-mono print:hidden">
